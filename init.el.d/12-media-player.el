...
(use-package emms
  ...
  :functions
  emms-info-initialize-track emms-playlist-mode emms-info-track-description
  emms-mode-line-mode emms-mode-line-blank emms-playing-time-mode
  emms-last-played-update-current emms-browser-bdata-data emms-track-p
  emms-track-get user/seconds-to-duration user/emms-track-description
  user/emms-browser-safe-spec emms-seek emms-player-mpv-pause
  emms-player-mpv-resume user/toggle-play-pause emms-pause emms-next
  emms-previous emms-playlist-shuffle emms-seek-backward emms-seek-forward
  user/seek-backward-med user/seek-forward-med user/seek-backward-long
  user/seek-forward-long emms-play-playlist emms-play-file emms-play-find
  emms-playlist-save emms-playlist-new emms-show emms-sort
  emms-playlist-mode-yank emms-playlist-mode-go-popup
  ...
  (dolist (emms-module
	   '(emms-playlist-mode
	     emms-info emms-info-exiftool emms-info-native emms-cache
	     emms-mode-line emms-mark emms-tag-editor emms-show-all
	     emms-playing-time emms-player-mpv emms-playlist-sort emms-browser
	     emms-mode-line-icon emms-cue emms-bookmarks emms-last-played
	     emms-metaplaylist-mode emms-history emms-volume emms-volume-mpv
	     emms-playlist-limit emms-mpris))
    (require emms-module)
    (message "%s loaded!" emms-module))
...
If TITLE is missing, use filename.  If ALBUM is missing, omit it."
  ...
  (setq
   ...
   emms-info-functions '(emms-info-native
			 emms-info-exiftool
			 emms-info-cueinfo)
   emms-track-description-function #'user/emms-track-description
...
This wrapper function has fallback in case emms-playlist-buffer not defined."
    (cond
     ((and (fboundp emms-playlist-buffer) (buffer-live-p emms-playlist-buffer))
      (funcall func))
